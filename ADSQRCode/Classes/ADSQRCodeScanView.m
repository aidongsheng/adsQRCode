...
#define ScanLineH 40
@interface ADSQRCodeScanView ()<AVCaptureMetadataOutputObjectsDelegate> // 用于处理采集信息的代理
{
...
@end
@implementation ADSQRCodeScanView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        // 设定颜色组
        scanLayer.colors = @[(__bridge id)[UIColor clearColor].CGColor,(__bridge id)[UIColor blackColor].CGColor];
